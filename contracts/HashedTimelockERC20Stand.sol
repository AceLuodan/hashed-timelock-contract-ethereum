...
* Protocol:
*
*  1) depositFunds(receiver, hashlock, timelock, tokenContract, amount) - a
 ...
 */
contract HashedTimelockERC20Stand {
    event DepositFunds(
    ...
    event WithdrawFunds(bytes32 indexed contractId,address receive,bytes32 preimage);
    ...
    modifier futureTimelock(uint256 _time) {
        ...
        require(_time > 0, "timelock time must be in the future");
        _;
    }
        ...
        returns (bytes32 contractId)
    {
       ...
       uint _timelockFuture = _timelock + block.timestamp;
    ...
    * @return bool true on success
     */
    function withdrawFunds(bytes32 _contractId, bytes32 _preimage)
        external
        ...
        returns (bool)
    {
        ...
        emit WithdrawFunds(_contractId,msg.sender,_preimage);
        return true;
    }
